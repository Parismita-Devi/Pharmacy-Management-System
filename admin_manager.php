...
$user=$_POST['username'];
$pas=$_POST['password'];
$sq1="SELECT * FROM manager WHERE username='$user'";
$sql1=mysqli_query($con, $sq1)or die(mysqli_error());
 $result=mysqli_fetch_array($sq1);
 if($result>0){
$message="<font color=blue>sorry the username entered already exists</font>";
 }else{
 	$sq="INSERT INTO manager(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)
VALUES('$fname','$lname','$sid','$postal','$phone','$email','$user','$pas',NOW())";
$sql=mysqli_query($con, $sq);
if($sql>0) {header("location:admin_manager.php");
}else{
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/snakes.png"></a> Pharmacy System</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<div id="footer" align="Center"> Pharmacy Sys 2020</div>
</div>
</body>
</html>
