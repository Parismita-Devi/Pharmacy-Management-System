...
$user=$_POST['username'];
$pas=$_POST['password'];
$sq1="SELECT * FROM cashier WHERE username='$user'";
...
$message="<font color=blue>sorry the username entered already exists</font>";
 	...
 	$sq="INSERT INTO cashier(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)
VALUES('$fname','$lname','$sid','$postal','$phone','$email','$user','$pas',NOW())";
$sql=mysqli_query($con, $sq);
if($sql>0) {header("location:admin_cashier.php");
}else{
