...
if($sql>0) {header("location:stock_pharmacist.php");
}else{
...
<div id="content">
<div id="header">
<h1><a href="#"><img src="images/snakes.png"></a> Pharmacy Sys</h1></div>
<div id="left_column">
<div id="button">
<ul>
...
<div id="footer" align="Center"> Pharmacy System 2020</div>
</div>
</body>
</html>
